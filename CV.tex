...
\usepackage{etoolbox} % should already be in your preamble
\newenvironment{nestedhang}[2]{%
...
\emergencystretch=3em  % allows more stretch before hyphenating
\hyphenpenalty=500     % discourages hyphenation (default is 50)
\exhyphenpenalty=50    % penalty for explicit hyphens (e.g. foo-bar)
...
\textbf{Past President}, Confederation of Alberta Faculty Associations (CAFA), 2024–2025

\begin{adjustwidth}{1em}{0pt}
Continued strategic advocacy; transitioned president role following reorganisation
\end{adjustwidth}

\textbf{President}, CAFA, 2023–2024
...
\textbf{Past President}, University of Lethbridge Faculty Association (ULFA), 2023–2024

\begin{adjustwidth}{1em}{0pt}
Supported transition to new leadership; advised on grievance resolution and governance rebuilding
\end{adjustwidth}

\textbf{President}, ULFA, 2021–2023
...
\textbf{Founding Director}, Digital Medievalist, 2003–2009

\begin{adjustwidth}{1em}{0pt}
Established peer-reviewed journal and infrastructure for medievalists working in digital media
\end{adjustwidth}

\textbf{Chair}, Department of English, University of Lethbridge, 2005–2008, 2023–present
