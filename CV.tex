...
\cvitem{\textbf{Summary}}{\textit{Comprehensive list of service activities. Many of the most significant leadership roles (presidencies, chairships, founding directorships) are described in detail in the \emph{Academic Leadership} section above; they are listed here in line-item form together with a wider set of contributions.}}
